    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.FName = Input.Name;
                user.UserSurname = Input.Surname;
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Подтверждение почты",
                        $"Пожалуйста подтвердите ваш аккаунт <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Клик</a>.");
